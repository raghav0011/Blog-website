    ...
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        <h1 className="font-roboto text-3xl text-center font-bold text-dark-soft md:text-5xl lg:text-4xl xl:5xl lg:text-left lg:max-w-[540px]">
          Read the most inresting articles
        </h1>
        <p className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste
          consectetur soluta at totam alias ipsa voluptate.
        </p>
        ...
        <div className="flex mt-4 flex-col lg:flex-row lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7">
          <span className="text-dark-light font-sembold italic mt-2 lg:mt-4 lg:text-sm xl:text-base">Popular Tags:</span>
